// src/pages/Login.tsx (YENİ VE CİLALANMIŞ HALİ)
...
function Login() {
  ...
  // handleLogin fonksiyonu aynı, çünkü zaten mükemmel çalışıyor.
  ...
  return (
    ...
    <Center style={{ height: 'calc(100vh - 120px)' }}>
      <Paper withBorder shadow="md" p="xl" radius="md" w={450}>
        ...
        {/* 1. YENİ: Marka kimliği için logo ekliyoruz */}
        ...
        <form onSubmit={handleLogin}>
          <Stack gap="md">
            ...
            {/* 2. GÜNCELLEME: Hata mesajını daha verimli hale getiriyoruz */}
            {error && (
              <Alert 
